cmd_arch/arm/cpu/armv7/mx6/soc.o := arm-linux-gnueabihf-gcc -Wp,-MD,arch/arm/cpu/armv7/mx6/.soc.o.d  -nostdinc -isystem /opt/gcc-linaro-arm-linux-gnueabihf-4.9-2014.09_linux/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include -Iinclude  -I/home/linux/imx6solo/u-boot/u-boot-imx/arch/arm/include -D__KERNEL__ -DCONFIG_SYS_TEXT_BASE=0x17800000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -DCONFIG_ARM -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(soc)"  -D"KBUILD_MODNAME=KBUILD_STR(soc)" -c -o arch/arm/cpu/armv7/mx6/soc.o arch/arm/cpu/armv7/mx6/soc.c
...
deps_arch/arm/cpu/armv7/mx6/soc.o := \
  ...
  /home/linux/imx6solo/u-boot/u-boot-imx/arch/arm/include/asm/armv7.h \
    $(wildcard include/config/armv7/nonsec.h) \
    $(wildcard include/config/armv7/virt.h) \
  /home/linux/imx6solo/u-boot/u-boot-imx/arch/arm/include/asm/pl310.h \
  ...
  /home/linux/imx6solo/u-boot/u-boot-imx/arch/arm/include/asm/imx-common/dma.h \
