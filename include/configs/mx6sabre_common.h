...
#define CONFIG_MFG_ENV_SETTINGS \
	"mfgtool_args=setenv bootargs console=" CONFIG_CONSOLE_DEV ",115200 " \
		...
		"bootargs=console=ttymxc3,115200 root=/dev/mmcblk0p2 rw init=/linuxrc video=mxcfb0:dev=ldb,if=RGB24 ldb=spl0 fbmem=24\0" \
...
#define CONFIG_BOOTCOMMAND \
	"mmc dev 0;" \
	"mmc read 0x11ffffc0 0x800 0x3000;" \
	"mmc read 0x18000000 0x5000 0x800;" \
