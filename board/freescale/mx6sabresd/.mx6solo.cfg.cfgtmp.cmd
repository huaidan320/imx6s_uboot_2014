cmd_board/freescale/mx6sabresd/mx6solo.cfg.cfgtmp := arm-linux-gnueabihf-gcc -E -Wp,-MD,board/freescale/mx6sabresd/.mx6solo.cfg.cfgtmp.d  -nostdinc -isystem /opt/gcc-linaro-arm-linux-gnueabihf-4.9-2014.09_linux/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include -Iinclude  -I/home/linux/github/imx6s_uboot_2014/arch/arm/include -D__KERNEL__ -DCONFIG_SYS_TEXT_BASE=0x17800000   -DCONFIG_ARM -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations  -march=armv7-a  -mno-unaligned-access  -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe   -x c -o board/freescale/mx6sabresd/mx6solo.cfg.cfgtmp board/freescale/mx6sabresd/mx6solo.cfg
